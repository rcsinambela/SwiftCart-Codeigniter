					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<span class="float-end">
								Sort by Price <a href="<?= base_url("/shop/sortby/asc") ?>" class="badge rounded-pill text-bg-primary">Cheapest</a> |
								<a href="<?= base_url("/shop/sortby/desc") ?>" class="badge rounded-pill text-bg-primary">Most expensive</a>
							</span>
						</div>
					...
					<div class="col-md-6">
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<a href="<?= base_url("/shop/category/$row->category_slug") ?>" class="badge rounded-pill text-bg-primary"><i class="fas fa-tags me-2"></i><?= $row->category_title ?></a>
							</div>
